      ...
      <main id="main-content" className="container mx-auto px-4">
        ...
        <section className="mb-16 text-center">
          ...
          <h1 className="mb-6 text-5xl font-bold text-foreground md:text-6xl animate-fade-in-up">
            Meet the Team Behind <span className="text-primary">Braillience AI</span>
          </h1>
            ...
            <CardContent className="p-0">
              <div className="bg-gradient-to-br from-primary/10 to-accent/10 p-8 md:p-12">
                ...
                <div className="space-y-4 text-lg text-foreground/80">
                  <p>
                    Braillience AI was born at <strong className="text-foreground">Cal Hacks 12.0</strong> from 
                  ...
                  <p>
                    Over 48 hours, our team built the foundation for Braillience AI—a platform that combines 
